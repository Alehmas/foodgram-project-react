# Generated by Django 2.2.19 on 2022-06-19 16:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='shopping',
            constraint=models.UniqueConstraint(fields=('user', 'recipe'), name='unique_shoprecipe'),
        ),
        migrations.AddConstraint(
            model_name='ingredientamount',
        ...
        migrations.AddConstraint(
            model_name='favorite',
            constraint=models.UniqueConstraint(fields=('user', 'recipe'), name='unique_favrecipe'),
        ),
    ]
