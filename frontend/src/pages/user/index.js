  ...
  return <Main>
    <Container className={styles.container}>
      <MetaTags>
        ...
        <meta name="description" content={user ? `Product assistant - ${user.first_name} ${user.last_name}` : 'Product assistant - User page'} />
      ...
      >
        {subscribed ? 'Unfollow Author' : 'Follow Author'}
      </Button>}
      <CardList>
